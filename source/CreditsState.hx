...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['LG64',	'levi',				'Port Modcharts, mechanics and dialogue',					'https://youtube.com/c/LG64TUBE', 	'F73838'],
            ['Random',	'none',				'Make No Storage Version',					'https://youtube.com/channel/UC9ZKGvBODHIj0YL1xgtbLcA', 	'F73838'],   
            ['Newbion',	'none',				'Fixed No Storage Version',					'https://youtube.com/channel/UCBnA4A3qCiG__-u7YnoMYcg', 	'F73838'],   
            ['MarioMaster',	'none',				'Finding code to make lua work and fix for 0.5.2h',					'https://youtube.com/c/MarioMaster1997', 	'F73838'],   
